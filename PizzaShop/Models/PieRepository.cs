...
namespace PizzaShop.Models
{
    public class PieRepository : IPieRepository
    {
        ...
        {
            Category c1 = new Category(1, "Pice sa mesom", "Opis za kategoriju 1", AllPies);
            Category c2 = new Category(2, "Veganske pice", "Opis za kategoriju 2", AllPies);
            Category c3 = new Category(3, "Pice bez glutena", "Opis za kategoriju 3", AllPies);
